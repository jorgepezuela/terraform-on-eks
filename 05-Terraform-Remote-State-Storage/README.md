...
- Copy folder `03-AWS-EKS-Cluster-Basics/01-ekscluster-terraform-manifests` to `05-Terraform-Remote-State-Storage/`
- Copy folder `04-Kubernetes-Resources-via-Terraform/02-k8sresources-terraform-manifests` to `05-Terraform-Remote-State-Storage/`
